...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_ids', type=str, default='3,4,5,6')
    ...
    parser.add_argument('--train_dir', type=str,
                        default='dataset/cmrc2018/train_features_roberta256.json')
    parser.add_argument('--dev_dir1', type=str,
                        default='dataset/cmrc2018/dev_examples_roberta256.json')
    parser.add_argument('--dev_dir2', type=str,
                        default='dataset/cmrc2018/dev_features_roberta256.json')
    ...
    parser.add_argument('--checkpoint_dir', type=str,
                        default='check_points/cmrc2018/roberta_zh_large/')
