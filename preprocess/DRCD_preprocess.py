...
def json2features_xlnet(input_file, output_files, sp_model, is_training=False, max_query_length=64,
    ...
    def read_squad_examples(input_file, is_training):
        ...
        for entry in input_data:
            for paragraph in entry["paragraphs"]:
                ori_paragraph_text = paragraph["context"]
                paragraph_text = Traditional2Simplified(ori_paragraph_text)
                for qa in paragraph["qas"]:
                    qas_id = qa["id"]
                    question_text = qa["question"]
                    question_text = Traditional2Simplified(question_text)
                    start_position = None
                    ...
                    if is_training:
                        ...
                        if not is_impossible:
                            ...
                            orig_answer_text = Traditional2Simplified(orig_answer_text)
                        else:
                            start_position = -1
                            orig_answer_text = ""
                    ...
                    example = {
                        ...
                        "ori_paragraph_text": ori_paragraph_text,
    ...
    def convert_examples_to_features(examples, sp_model, max_seq_length,
        ...
        for (example_index, example) in enumerate(examples):
            ...
            paragraph_text = Traditional2Simplified(paragraph_text)
